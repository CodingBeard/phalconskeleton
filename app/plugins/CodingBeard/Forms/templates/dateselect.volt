...
<div class="col l{{ size }} m12 s12">
  ...
  <div class="inline-selects">
    <select {{ requiredAttribute }} name="{{ key|escape_attr }}-year"
                                    class="browser-default {{ error|escape_attr }} {{ class|escape_attr }}">
    ...
    <select {{ requiredAttribute }} name="{{ key|escape_attr }}-month"
                                    class="browser-default {{ error|escape_attr }} {{ class|escape_attr }}">
    ...
    <select {{ requiredAttribute }} name="{{ key|escape_attr }}-day"
                                    class="browser-default {{ error|escape_attr }} {{ class|escape_attr }}">
